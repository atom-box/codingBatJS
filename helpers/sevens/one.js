...
code1El.innerHTML = `
<div>
<p>Turning the output of a rand5 into a rand7 worked on the second try.  My first solution was illogical: add 7 + 7 + 7 + 7 + 7 and divide by 5.  That output resembled a Gaussian curve.  I got better results when I divided 7 into five parts, rolled the rand5 die to find which part, then rolled the rand5 again to find how far along in the part.  That gave evenly distributed results.</p>
